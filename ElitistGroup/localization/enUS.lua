...
L["Elitist Group (%s): showing %d players, check out http://Warmane.com for more info. Format is, [name] (%s)"] = "Elitist Group (%s): showing %d players, check out http://Warmane.com for more info. Format is, [name] (%s)"
