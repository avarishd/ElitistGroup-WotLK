...
L["Elitist Group (%s): showing %d players, check out https://github.com/avarishd/ElitistGroup-WotLK for more info. Format is, [name] (%s)"] = "Elitist Group (%s): showing %d players, check out https://github.com/avarishd/ElitistGroup-WotLK for more info. Format is, [name] (%s)"
...
L["View the group on Warmane.com"] = "View the group on Warmane.com"
L["View the player on Warmane.com"] = "View the player on Warmane.com"
